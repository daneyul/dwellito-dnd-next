  ...
  componentData
    ...
    .forEach(component => {
      if (component.objType === COMPONENT_TYPES.DOOR) {
        ...
        promises.push(useGLTF.preload(`/models/${supplier}/doors/${component.model}.glb`));
      } else if (component.objType === COMPONENT_TYPES.WINDOW) {
        promises.push(useGLTF.preload(`/models/${supplier}/windows/${component.model}.glb`));
      } else if (component.objType === COMPONENT_TYPES.VENT) {
        promises.push(useGLTF.preload(`/models/${supplier}/vents/${component.model}.glb`));
      }
    });
