...
const SconceWallLight = ({ component }) => {
  const {
    supplier,
    selectedComponents,
    selectedContainer,
  ...
  const { nodes, materials } = useGLTF(
    `/models/${supplier}/electrical/farmhouse-wall-sconce.glb`
  );
  ...
  return (
    <group
        ...
        rotation={rotation}
      >
        <group position={[3.9, 23.25, 0]} rotation={[0, Math.PI, 0]} scale={0.25}>
          <group>
...
export default SconceWallLight;
