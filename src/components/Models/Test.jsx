  ...
  return (
    <mesh receiveShadow castShadow>
      <Geometry ref={csg} useGroups>
        <Base geometry={rightNodes.mesh_0.geometry} material={material} scale={10} position={[adjustForX, 0, adjustForY]} />
        <Base geometry={backNodes.mesh_0.geometry} material={material} scale={10} position={[adjustForX, 0, adjustForY]} />
        <Base geometry={leftNodes.mesh_0.geometry} material={material} scale={10} position={[adjustForX, 0, adjustForY]} />
        <PivotControls
          lineWidth={3}
          anchor={[0, 0, 0]}
